// widget/edukasi/lihat_semua_pertolongan.dart
...
class _LihatSemuaPertolonganScreenState
  ...
  Future<void> fetchArticles() async {
    final url = Uri.parse(
      'https://mediquick.my.id/api_article.php?type=Pertolongan Pertama',
    );
          ...
          setState(() {
            articles =
                (body['data'] as List)
                    .map(
                      (json) =>
                          Article.fromJson(Map<String, dynamic>.from(json)),
                    )
                    .toList();
            isLoading = false;
          });
